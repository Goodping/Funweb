		...
		<article>
			...
			<form action="notice_updatePro.jsp" method="post">
				...
				<table id="notice">
					<tr>
						<td>글쓴이</td>
						<td><input type="text" name="name" readonly="readonly" value="<%=board.getName() %>"></td>
					</tr>
					<tr>
						<td>비밀번호</td>
					...
					<tr>
						<td>내용</td>
						<td><textarea style="resize: none;" rows="10" cols="22" name="content" required="required"><%=board.getContent() %></textarea></td>
					</tr>
				</table>
